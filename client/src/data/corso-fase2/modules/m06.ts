...
const CINQUE_DIMENSIONI: ExpandableCardData[] = [
  {
    ...
    detail: `
      ...
      <p class="corso-card__hint corso-card__hint--accent"><strong>Esempio</strong> · <code>N1~ N2↑ N3~ N4↓ N5~ N6~ N7~</code></p>
    `,
  },
  {
    id: 'R',
    ...
    detail: `
      ...
      <p class="corso-card__hint corso-card__hint--accent"><strong>Esempio</strong> · <code>N2→N3 (MED), N7→N3 (CPL), N2→N1 (CMP)</code></p>
    `,
  },
  {
    id: 'D',
    ...
    detail: `
      ...
      <p class="corso-card__hint corso-card__hint--accent"><strong>Esempio</strong> · <code>↗</code></p>
    `,
  },
  {
    id: 'T',
    ...
    detail: `
      ...
      <p class="corso-card__hint corso-card__hint--accent"><strong>Esempio</strong> · <code>T2</code></p>
    `,
  },
  {
    id: 'A',
    ...
    detail: `
      ...
      <p class="corso-card__hint corso-card__hint--accent"><strong>Esempio</strong> · <code>A±</code></p>
    `,
  },
];
...
const DECODIFICA_STEPS: ProgressiveRevealItem[] = [
  {
    ...
    bodyHtml: `
      ...
      <details>
        <summary style="cursor: pointer; color: var(--corso-module-accent); font-weight: 600;">Mostra risposta</summary>
  ...
  },
  {
    ...
    bodyHtml: `
      <p style="font-family: 'JetBrains Mono', monospace; background: var(--corso-bg); padding: 8px 12px; border-radius: var(--corso-radius-sm);">N2→N3 (MED), N7→N3 (CPL), N2→N1 (CMP)</p>
  ...
  },
  {
    ...
    bodyHtml: `
      <p style="font-family: 'JetBrains Mono', monospace; background: var(--corso-bg); padding: 8px 12px; border-radius: var(--corso-radius-sm);">D: ↗</p>
  ...
  },
  {
    ...
    bodyHtml: `
      <p style="font-family: 'JetBrains Mono', monospace; background: var(--corso-bg); padding: 8px 12px; border-radius: var(--corso-radius-sm);">T: T2 &nbsp;·&nbsp; A: A±</p>
...
export const Module06: Module = {
  ...
  slides: [
    // ─── 6.1 ──────────────────────────────────────────────────────────
    {
      ...
      content: `
        ...
        <blockquote class="corso-blockquote" style="border-left-color: #16a085; background: #e8f8f5;">«Una <strong>Configurazione Evolutiva</strong> è la forma temporaneamente stabile assunta dalla dinamica tra Nodi Trasversali in un determinato campo relazionale.»</blockquote>

        <div class="corso-chips">
          <div class="corso-chip" style="background: #e8f8f5; border-color: #16a085;"><span class="corso-chip__icon">📍</span><span class="corso-chip__label">Situata</span><span class="corso-chip__sub">dipende dal campo, dall'adulto, dal contesto</span></div>
          <div class="corso-chip" style="background: #e8f8f5; border-color: #16a085;"><span class="corso-chip__icon">🔄</span><span class="corso-chip__label">Reversibile</span><span class="corso-chip__sub">può cambiare; non è una sentenza</span></div>
          <div class="corso-chip" style="background: #e8f8f5; border-color: #16a085;"><span class="corso-chip__icon">📈</span><span class="corso-chip__label">Dinamica</span><span class="corso-chip__sub">descrive movimento, non stato fisso</span></div>
        </div>

        <p class="corso-narrative__caption">Una CE non dice cosa è il bambino. Dice come il campo relazionale funziona in questo momento. Questo è il senso preciso di «produrre leggibilità» — l'obiettivo della Fase 2.</p>
      `,
    },
    ...
    // ─── 6.3 ──────────────────────────────────────────────────────────
    {
      ...
      content: `
        <div class="corso-two-col">
          <div class="corso-col">
            <h3 class="corso-narrative__h3">Blocco CE</h3>
  ...
  <span title="Campo fragile ma evolutivamente aperto">A: A±</span>
            ...
            <p class="corso-narrative__caption">Passa il mouse sopra ogni riga per leggerne il significato.</p>
          </div>

          <div class="corso-col">
            <h3 class="corso-narrative__h3">Testo naturale</h3>
            <div class="corso-box corso-box--valid" style="border-color: #16a085; background: #e8f8f5;">
              <p><em>«Campo relazionale espansivo che orienta e sostiene l'accesso al mondo condiviso, con esplorazione ancora ridotta. La configurazione è fragile ma con direzione evolutiva aperta.»</em></p>
            </div>

            <div class="corso-chip" style="margin-top: 12px;">
              <span class="corso-chip__icon">🩺</span>
              <span class="corso-chip__label">Contesto</span>
              <span class="corso-chip__sub">Bilancio pediatrico · 18-24 mesi · 3-5 minuti di lettura condivisa con genitore presente</span>
            </div>

            <p class="corso-narrative__caption">Il testo naturale non è una diagnosi. È la restituzione leggibile della struttura — per il professionista, non per la famiglia.</p>
          </div>
        </div>
      `,
    },
    ...
    // ─── 6.5 ──────────────────────────────────────────────────────────
    {
      ...
      intro: `
        <blockquote class="corso-blockquote" style="border-left-color: #16a085; background: #e8f8f5; font-size: 1.2rem;">
      ...
      content: `
        <p class="corso-narrative__caption">Questa regola non è una cautela etica aggiuntiva: è strutturalmente necessaria. Una CE che descrivesse il bambino non sarebbe più una CE — sarebbe una diagnosi. Il metodo non prevede diagnosi.</p>
      `,
    },
    ...
    // ─── 6.6 ──────────────────────────────────────────────────────────
    {
      ...
      intro: `
        <pre style="background: var(--corso-bg); border: 1px solid var(--corso-border); border-left: 4px solid #16a085; border-radius: var(--corso-radius-md); padding: 16px; font-family: 'JetBrains Mono', 'Fira Code', monospace; font-size: 0.88rem; line-height: 1.7; margin: 0 0 12px;">CE =
  S: N1~ N2↑ N3~ N4↓ N5~ N6~ N7~
  ...
  A: A±</pre>
      ...
      interactive: {
        ...
        conclusionHtml: `
          <p class="corso-emph corso-emph--center">→ Modulo 7 — Costruzione di un Output-tipo vuoto</p>
        `,
      },
    },
    ...
    // ─── 6.7 ──────────────────────────────────────────────────────────
    {
      ...
      content: `
        ...
        <h3 class="corso-narrative__h3">Cosa ha prodotto F2</h3>
        <div class="corso-cards corso-cards--vertical">
          <div class="corso-card corso-card--open" style="--corso-card-accent: #16a085;">
            <div class="corso-card__head"><span class="corso-card__badge">🔍</span><span class="corso-card__title">Operatori di lettura</span></div>
            <div class="corso-card__body"><p>Domande strutturali che organizzano l'osservazione professionale, situate nei contesti reali.</p></div>
          </div>
          <div class="corso-card corso-card--open" style="--corso-card-accent: #16a085;">
            <div class="corso-card__head"><span class="corso-card__badge">📐</span><span class="corso-card__title">Configurazioni Evolutive</span></div>
            <div class="corso-card__body"><p>Descrizioni comparabili e reversibili del campo, scritte con la grammatica S/R/D/T/A.</p></div>
          </div>
          <div class="corso-card corso-card--open" style="--corso-card-accent: #16a085;">
            <div class="corso-card__head"><span class="corso-card__badge">🌉</span><span class="corso-card__title">Linguaggio condiviso</span></div>
            <div class="corso-card__body"><p>Traducibile in pediatria, NPI, educazione, counseling — preservando l'autonomia di ciascuna disciplina e mantenendo aperto un terreno comune di lettura.</p></div>
          </div>
        </div>
        ...
        <div class="corso-box corso-box--valid" style="border-color: #f1c40f; background: #fef9e7;">
        ...
        <p class="corso-narrative__caption">Nel caso-guida la CE <code>A±, T2, ↗</code> indica che il bilancio pediatrico non richiede un intervento direttivo, ma un protocollo di monitoraggio condiviso con la famiglia — questo è il compito di F3.</p>
      `,
    },
  ],
};
