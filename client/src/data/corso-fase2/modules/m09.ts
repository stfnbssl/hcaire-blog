  ...
  slides: [
    // ─── 9.1 ──────────────────────────────────────────────────────────
    {
      ...
      content: `
        ...
        <div class="cf2-scena" style="border-left-color: #c0392b; max-width: 720px; margin: 16px auto;">
        ...
        <h3 class="cf2-narrative__h3" style="text-align: center;">La mappa della pipeline</h3>
        <div style="display: flex; flex-wrap: wrap; align-items: center; justify-content: center; gap: 4px; margin: 12px 0;">
          ${TOPBAR_STEPS.map(
            (s, i) =>
              `${i > 0 ? '<span style="color: var(--cf2-text-muted); margin: 0 2px;">→</span>' : ''}<span style="background: ${s.color}; color: white; padding: 4px 10px; border-radius: var(--cf2-radius-sm); font-family: 'JetBrains Mono', monospace; font-size: 0.78rem; font-weight: 700;">${s.label}</span>`,
          ).join('')}
        </div>

        <p class="cf2-narrative__caption" style="text-align: center;">Ogni passo produce qualcosa di preciso. Ogni guardrail controlla che non si faccia troppo presto.</p>
      `,
    },
    ...
    // ─── 9.2 ──────────────────────────────────────────────────────────
    {
      ...
      content: `
        ...
        <blockquote class="cf2-blockquote" style="border-left-color: #1a6b8a;">
        ...
        <h3 class="cf2-narrative__h3">Come cambia la lettura</h3>
        <table class="cf2-table">
          <thead><tr><th>Senza F1</th><th>Con F1</th></tr></thead>
          <tbody>
            <tr><td style="color: var(--cf2-text-muted); text-decoration: line-through;">«Il bambino sa indicare»</td><td style="color: #1a6b8a;">«Il bambino usa il gesto per aprire uno scambio con l'adulto»</td></tr>
            <tr><td style="color: var(--cf2-text-muted); text-decoration: line-through;">«Il bambino ha buone competenze linguistiche»</td><td style="color: #1a6b8a;">«Il libro diventa mediatore di un campo comune»</td></tr>
            <tr><td style="color: var(--cf2-text-muted); text-decoration: line-through;">«Il bambino non presta attenzione»</td><td style="color: #1a6b8a;">«Il campo condiviso fatica a stabilizzarsi in questa sequenza»</td></tr>
          </tbody>
        </table>

        <p class="cf2-narrative__caption">Da questa tesi, la pipeline può cominciare.</p>
      `,
    },
    ...
    // ─── 9.3 ──────────────────────────────────────────────────────────
    {
      ...
      content: `
        <div class="cf2-two-col cf2-two-col--40-60" style="grid-template-columns: 1.4fr 1fr;">
          <div class="cf2-col">
            <table class="cf2-table">
              ...
              <tbody>
                ...
                <tr style="background: var(--cf2-bg);"><td><strong>Non osservabile</strong></td><td>Motivazione interna, competenza stabile, intenzione profonda</td></tr>
              </tbody>
            </table>
          </div>
          <div class="cf2-col">
            <div class="cf2-box cf2-box--valid" style="border-color: #2d6a4f; background: #eafaf1;">
              <div class="cf2-box__title" style="color: #2d6a4f;">Cosa produce</div>
            ...
            <p class="cf2-narrative__caption" style="font-style: italic; margin-top: 12px;">«Posso immaginare una scena osservabile? Se no, non siamo ancora davanti a un campo di lavoro.»</p>
          </div>
        </div>
      `,
      guardrail: {
    ...
    // ─── 9.4 ──────────────────────────────────────────────────────────
    {
      ...
      subtitle: 'Tradurre senza ridurre',
      pipelineTopbar: topbar('concetto'),
      intro: `
        <div class="cf2-box cf2-box--valid" style="border-color: #6c63ff; background: #ece9ff;">
          <div class="cf2-box__title" style="color: #6c63ff;">Concetto-ponte</div>
          <p style="font-size: 1.1rem;"><strong>«Accesso al mondo condiviso»</strong></p>
          <p class="cf2-narrative__caption">Non «attenzione condivisa» (rischia di diventare competenza psicologica specifica). Ma «accesso al mondo condiviso» — mantiene l'ampiezza ontologica: corpo, gesto, parola, attesa, significato culturale insieme.</p>
        </div>
      `,
      comparison: {
        valid: {
        ...
        invalid: {
          ...
          items: [
            { text: '«Il bambino presta attenzione»', problem: 'riduce a funzione attentiva' },
            { text: '«Il bambino sa indicare»', problem: 'riduce a comportamento' },
            { text: '«Il genitore stimola bene»', problem: "sposta verso giudizio sull'adulto" },
          ],
        },
      },
      guardrail: {
        ...
        <div class="cf2-two-col">
          <div class="cf2-col">
            <div class="cf2-card cf2-card--open" style="--cf2-card-accent: #e67e22;">
              <div class="cf2-card__head"><span class="cf2-card__badge">N3</span><span class="cf2-card__title">Accesso al mondo condiviso simbolico</span></div>
            ...
            <p class="cf2-narrative__caption">Il libro non è solo un oggetto. È un <strong>mediatore di mondo</strong>: permette al bambino e all'adulto di orientarsi verso qualcosa che sta tra loro.</p>
          </div>
          ...
          <div class="cf2-col">
            ...
            <p class="cf2-narrative__caption" style="margin-top: 8px;">4 assi su 6 attivati — è un nodo, non una variabile singola.</p>
          </div>
        </div>
      `,
      guardrail: {
      ...
      content: `
        <div class="cf2-two-col">
          <div class="cf2-box cf2-box--valid">
            <div class="cf2-box__title">Domande valide — lettura condivisa</div>
            <ul>
              <li>«Il libro diventa oggetto comune o resta in uso parallelo?» <em style="color: var(--cf2-text-muted); font-size: 0.85rem;">— legge la qualità del campo</em></li>
              <li>«C'è alternanza di sguardo tra libro e adulto?» <em style="color: var(--cf2-text-muted); font-size: 0.85rem;">— osservabile direttamente</em></li>
              <li>«Il gesto apre una relazione o rimane azione solitaria?» <em style="color: var(--cf2-text-muted); font-size: 0.85rem;">— distingue azione da comunicazione</em></li>
              <li>«Lo scambio si mantiene, si interrompe, si riprende?» <em style="color: var(--cf2-text-muted); font-size: 0.85rem;">— legge la continuità</em></li>
              <li>«Il bambino introduce qualcosa di proprio o risponde solo all'adulto?» <em style="color: var(--cf2-text-muted); font-size: 0.85rem;">— legge la posizione soggettiva</em></li>
            </ul>
          </div>
          <div class="cf2-box cf2-box--invalid">
            <div class="cf2-box__title">Domande da evitare</div>
            <ul>
              <li>«Il bambino è in ritardo?» <strong style="color: var(--cf2-invalid);">— diagnostica</strong></li>
              <li>«Il genitore legge bene?» <strong style="color: var(--cf2-invalid);">— valutativa</strong></li>
              <li>«Bisogna insegnare al genitore?» <strong style="color: var(--cf2-invalid);">— già operativa</strong></li>
            </ul>
          </div>
        </div>
      `,
      ...
      content: `
        <div class="cf2-cards cf2-cards--grid">
          <div class="cf2-card cf2-card--open" style="--cf2-card-accent: #16a085;">
            ...
            <div class="cf2-card__body"><p><em>«Il bambino e l'adulto si orientano verso qualcosa di comune (il libro), con gesto, sguardo e parola che si intrecciano.»</em></p></div>
          </div>
          <div class="cf2-card cf2-card--open" style="--cf2-card-accent: #8e44ad;">
            ...
            <div class="cf2-card__body"><p><em>«Il bambino indica, mostra, vocalizza: c'è iniziativa soggettiva e non solo reazione all'adulto.»</em></p></div>
          </div>
          <div class="cf2-card cf2-card--open" style="--cf2-card-accent: #d35400;">
            ...
            <div class="cf2-card__body"><p><em>«Il bambino accetta di condividere il controllo del libro con l'adulto; la sequenza si interrompe e riprende.»</em></p></div>
          </div>
        </div>

        <hr class="cf2-divider" />

        <div class="cf2-box cf2-box--valid" style="border-color: #c0392b; background: #fdedec;">
          <div class="cf2-box__title" style="color: #c0392b;">Lettura sintetica</div>
      ...
      content: `
        <div class="cf2-cards cf2-cards--grid">
          <div class="cf2-card cf2-card--open" style="--cf2-card-accent: #2980b9;">
            <div class="cf2-card__head"><span class="cf2-card__badge" style="background: #2980b9;">1</span><span class="cf2-card__title">Osservativa</span></div>
            <div class="cf2-card__body"><p>Scheda di osservazione della lettura condivisa</p></div>
          </div>
          <div class="cf2-card cf2-card--open" style="--cf2-card-accent: #16a085;">
            <div class="cf2-card__head"><span class="cf2-card__badge" style="background: #16a085;">2</span><span class="cf2-card__title">Formativa</span></div>
            <div class="cf2-card__body"><p>Micro-modulo per pediatri o educatori</p></div>
          </div>
          <div class="cf2-card cf2-card--open" style="--cf2-card-accent: #8e44ad;">
            <div class="cf2-card__head"><span class="cf2-card__badge" style="background: #8e44ad;">3</span><span class="cf2-card__title">Restitutiva</span></div>
            <div class="cf2-card__body"><p>Traccia di colloquio con il genitore</p></div>
          </div>
          <div class="cf2-card cf2-card--open" style="--cf2-card-accent: #27ae60;">
            <div class="cf2-card__head"><span class="cf2-card__badge" style="background: #27ae60;">4</span><span class="cf2-card__title">Ricerca</span></div>
            <div class="cf2-card__body"><p>Griglia per confrontare sequenze video</p></div>
          </div>
          <div class="cf2-card cf2-card--open" style="--cf2-card-accent: #c0392b;">
            <div class="cf2-card__head"><span class="cf2-card__badge" style="background: #c0392b;">5</span><span class="cf2-card__title">Organizzativa</span></div>
            <div class="cf2-card__body"><p>Protocollo per i bilanci di salute</p></div>
          </div>
          <div class="cf2-card cf2-card--open" style="--cf2-card-accent: #7f8c8d;">
            <div class="cf2-card__head"><span class="cf2-card__badge" style="background: #7f8c8d;">6</span><span class="cf2-card__title">AI-assistita</span></div>
            <div class="cf2-card__body"><p>Prompt per analizzare trascrizioni</p></div>
          </div>
        </div>

        <p class="cf2-narrative__caption">Sei famiglie, un solo nodo, un solo concetto-ponte. La <strong>scalabilità</strong> è la prova che il nodo è davvero trasversale.</p>
      `,
      guardrail: {
        code: 'C5',
        label: 'Scalabilità',
    ...
    // ─── 9.9 ──────────────────────────────────────────────────────────
    {
      ...
      content: `
        <h3 class="cf2-narrative__h3">Scheda vuota di leggibilità del mondo condiviso</h3>

        <details>
          <summary style="cursor: pointer; font-weight: 600; color: #27ae60; padding: 8px 12px; border: 1px dashed var(--cf2-border); border-radius: var(--cf2-radius-sm); display: inline-block;">Mostra formula compilata</summary>

          <div class="cf2-box cf2-box--valid" style="border-color: #27ae60; background: #eafaf1; margin-top: 12px;">
        ...
        <div class="cf2-two-col">
          ...
          <div class="cf2-guardrail">
            ...
            <div class="cf2-guardrail__body">
              ...
              <p class="cf2-guardrail__text">La decisione operativa appartiene a F3 e alle responsabilità disciplinari specifiche.</p>
            </div>
          </div>
        </div>
      `,
  ...
  A: A±
          ...
          <div class="cf2-col">
            <div class="cf2-box cf2-box--valid" style="border-color: #16a085; background: #e8f8f5;">
              <div class="cf2-box__title" style="color: #16a085;">Testo naturale</div>
            ...
            <p class="cf2-narrative__caption">Questa CE non dice che il bambino è competente. Non dice che è in difficoltà. Dice come il campo relazionale funziona <em>in questo momento specifico</em>.</p>

            <div class="cf2-chip" style="background: #e8f8f5; border-color: #16a085; margin-top: 8px;">
              <span class="cf2-chip__label">Regola</span>
              <span class="cf2-chip__sub">La configurazione descrive il campo, non il bambino.</span>
            </div>
          </div>
        </div>
      `,
    ...
    // ─── 9.11 ─────────────────────────────────────────────────────────
    {
      ...
      content: `
        ...
        <h3 class="cf2-narrative__h3">Strumenti possibili in F3</h3>
        <table class="cf2-table">
        ...
        <div class="cf2-box cf2-box--invalid" style="border-color: #f39c12; background: #fef9e7;">
          <div class="cf2-box__title" style="color: #f39c12;">Cosa F2 non ha ancora fatto</div>
    ...
    // ─── 9.12 ─────────────────────────────────────────────────────────
    {
      ...
      content: `
        ...
        <ol class="cf2-card__body" style="font-size: 0.95rem; line-height: 1.8; padding-left: 24px;">
          <li>Parte da una situazione semplice e osservabile</li>
          <li>Conserva il riferimento alla fondazione ontologica</li>
          <li>Evita di ridurre il fenomeno a linguaggio, attenzione o comportamento</li>
        ...
        <div class="cf2-box cf2-box--valid" style="border-color: #c0392b; background: #fdedec; padding: 24px; margin-top: 16px;">
        ...
        <p class="cf2-emph cf2-emph--center" style="margin-top: 16px;">Da qui, la Fase 3 può costruire — con responsabilità.</p>
      `,
    },
  ],
};
