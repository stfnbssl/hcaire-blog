...
function stateBadges(states: Record<string, string>): string {
  return Object.entries(states)
    .map(
      ([n, s]) =>
        `<span class="corso-state" style="--node-color: ${NODE_COLORS[n]}; --state-color: ${STATE_COLORS[s]};"><span class="corso-state__node">${n}</span><span class="corso-state__sym">${s}</span></span>`,
    )
    .join('');
}
...
export const Module05: Module = {
  ...
  slides: [
    // ─── 5.1 ──────────────────────────────────────────────────────────
    {
      ...
      content: `
        <blockquote class="corso-blockquote">«Lo stato evolutivo di un bambino corrisponde a una configurazione di Nodi simultaneamente attivi, non alla loro somma.»</blockquote>
        ...
        <p class="corso-narrative__caption">Guardare un Nodo alla volta è come ascoltare un accordo una nota alla volta: si perde la musica.</p>

        <hr class="corso-divider" />

        <h3 class="corso-narrative__h3">Tre conseguenze operative</h3>
        <div class="corso-cards corso-cards--grid">
          <div class="corso-card corso-card--open" style="--corso-card-accent: #8e44ad;">
            <div class="corso-card__head"><span class="corso-card__badge">🔍</span><span class="corso-card__title">Per la lettura</span></div>
            <div class="corso-card__body"><p><em>Nessun Nodo, da solo, identifica il rischio o la risorsa. È la configurazione che parla.</em></p></div>
          </div>
          <div class="corso-card corso-card--open" style="--corso-card-accent: #8e44ad;">
            <div class="corso-card__head"><span class="corso-card__badge">🎯</span><span class="corso-card__title">Per l'intervento</span></div>
            <div class="corso-card__body"><p><em>L'intervento non si rivolge al «Nodo debole»: si rivolge alla configurazione. Si sostiene il campo, non si «riparano» i Nodi.</em></p></div>
          </div>
          <div class="corso-card corso-card--open" style="--corso-card-accent: #8e44ad;">
            <div class="corso-card__head"><span class="corso-card__badge">🗣</span><span class="corso-card__title">Per la comunicazione</span></div>
            <div class="corso-card__body"><p><em>Due professionisti che leggono Nodi diversi non si contraddicono: descrivono aspetti della stessa configurazione.</em></p></div>
          </div>
        </div>
      `,
      notes:
    ...
    // ─── 5.3 ──────────────────────────────────────────────────────────
    {
      ...
      content: `
        <h3 class="corso-narrative__h3" style="color: #27ae60;">CPL — Sostegno</h3>
        <p><em>Un Nodo rende possibile l'attivazione di un altro. Non è causalità diretta: è condizione di possibilità.</em></p>

        <div class="corso-scena" style="border-left-color: #27ae60; background: #e7f7ed;">
        ...
        <p class="corso-narrative__caption">In questa catena N1 non «causa» direttamente N7. Ma la sua fragilità si propaga attraverso N4. Per questo il bambino con bassa iniziativa spesso non ha «un problema di desiderio»: ha un problema di regolazione.</p>

        <hr class="corso-divider" />

        <h3 class="corso-narrative__h3" style="color: #e74c3c;">VIN — Vincolo</h3>
        <p><em>Un Nodo limita fisiologicamente un altro, in entrambe le direzioni. Il vincolo non è patologico: è strutturale.</em></p>

        <div class="corso-scena" style="border-left-color: #e74c3c; background: #fdecea;">
          <p style="font-family: 'JetBrains Mono', monospace; text-align: center; font-size: 1.1rem; margin: 0;">
        ...
        <table class="corso-table">
          ...
          <tbody>
            ...
            <tr class="corso-table__row--highlight"><td>Limite abitabile</td><td>~</td><td>~</td><td>Desiderio orientato, iniziativa stabile</td></tr>
          </tbody>
        </table>

        <p class="corso-narrative__caption">Il VIN tra N5 e N7 mostra perché il limite non è «il nemico del desiderio»: il limite ben calibrato è ciò che dà forma al desiderio.</p>
      `,
    },
    ...
    // ─── 5.4 ──────────────────────────────────────────────────────────
    {
      ...
      content: `
        <h3 class="corso-narrative__h3" style="color: #2980b9;">MED — Mediazione</h3>
        ...
        <div class="corso-scena" style="border-left-color: #2980b9; background: #e8f4f8;">
          <p style="font-family: 'JetBrains Mono', monospace; text-align: center; font-size: 1.1rem; margin: 0;">
        ...
        <div class="corso-box corso-box--valid" style="border-color: #2980b9; background: #e8f4f8;">
          <div class="corso-box__title" style="color: #2980b9;">Pattern frequente</div>
        ...
        <h3 class="corso-narrative__h3" style="color: #e67e22;">CMP — Compensazione</h3>
        ...
        <div class="corso-scena" style="border-left-color: #e67e22; background: #fef5ec;">
          <p style="font-family: 'JetBrains Mono', monospace; text-align: center; font-size: 1.05rem; margin: 0;">
            ...
            <span style="color: var(--corso-text-muted); font-size: 0.85rem;">il campo diventa più abitabile</span>
          </p>
        </div>
        ...
        <div class="corso-two-col">
          <div class="corso-box corso-box--valid" style="border-color: #e67e22; background: #fef5ec;">
            <div class="corso-box__title" style="color: #e67e22;">1. Non annulla il problema</div>
            <p>N1 resta fragile. La compensazione rende il campo abitabile oggi, ma non sostituisce il lavoro su N1 nel tempo.</p>
          </div>
          <div class="corso-box corso-box--valid" style="border-color: #e67e22; background: #fef5ec;">
            <div class="corso-box__title" style="color: #e67e22;">2. Cambia la lettura del rischio</div>
            <p>Un bambino con N1↓ ma N2↑ ha risorse che non emergono se si guarda solo N1. Una lettura centrata sul solo deficit lascia in ombra la compensazione che il campo relazionale già offre.</p>
          </div>
        </div>

        <p class="corso-emph corso-emph--center">Per questo la configurazione è l'unità di lettura — non il singolo Nodo.</p>
      `,
    },
    ...
    // ─── 5.5 ──────────────────────────────────────────────────────────
    {
      ...
      content: `
        <div class="corso-cards corso-cards--grid">
          <div class="corso-card corso-card--open" style="--corso-card-accent: #27ae60;">
            <div class="corso-card__head">
              <span class="corso-card__badge">A</span>
              <span class="corso-card__title">Espansiva integrata</span>
            </div>
            <div class="corso-card__body">
              <div style="margin: 8px 0;">${stateBadges({ N1: '↑', N2: '↑', N3: '↑', N4: '↑', N5: '~', N6: '~', N7: '↑' })}</div>
              <p style="font-size: 0.85rem; color: var(--corso-text-muted); font-family: 'JetBrains Mono', monospace;"><strong>R</strong>: CPL prevalente · <strong>D</strong>: ↗ · <strong>T</strong>: T2 · <strong>A</strong>: A+</p>
              ...
              <p class="corso-card__hint">Contesti familiari/educativi funzionanti; prevenzione universale.</p>
            </div>
          </div>

          <div class="corso-card corso-card--open" style="--corso-card-accent: #f39c12;">
            <div class="corso-card__head">
              <span class="corso-card__badge" style="background: #f39c12;">B</span>
              <span class="corso-card__title">Accesso situazionale</span>
            </div>
            <div class="corso-card__body">
              <div style="margin: 8px 0;">${stateBadges({ N1: '~', N2: '~', N3: '~', N4: '~', N5: '~', N6: '~', N7: '~' })}</div>
              <p style="font-size: 0.85rem; color: var(--corso-text-muted); font-family: 'JetBrains Mono', monospace;"><strong>R</strong>: MED fragile (N2→N3 discontinuo) · <strong>D</strong>: → · <strong>T</strong>: T1 · <strong>A</strong>: A±</p>
              ...
              <p class="corso-card__hint">Frequente nei bilanci pediatrici; zona di osservazione preventiva.</p>
            </div>
          </div>

          <div class="corso-card corso-card--open" style="--corso-card-accent: #e67e22;">
            <div class="corso-card__head">
              <span class="corso-card__badge" style="background: #e67e22;">C</span>
              <span class="corso-card__title">Campo ristretto</span>
            </div>
            <div class="corso-card__body">
              <div style="margin: 8px 0;">${stateBadges({ N1: '↓', N2: '~', N3: '~', N4: '↓', N5: '~', N6: '~', N7: '↓' })}</div>
              <p style="font-size: 0.85rem; color: var(--corso-text-muted); font-family: 'JetBrains Mono', monospace;"><strong>R</strong>: CPL mancato (N1↓ → N4 → N7) · <strong>D</strong>: ↘ · <strong>T</strong>: T2 · <strong>A</strong>: A±</p>
              ...
              <p class="corso-card__hint">Zona preventiva critica; richiede lettura attenta.</p>
            </div>
          </div>

          <div class="corso-card corso-card--open" style="--corso-card-accent: #e74c3c;">
            <div class="corso-card__head">
              <span class="corso-card__badge" style="background: #e74c3c;">D</span>
              <span class="corso-card__title">Disorganizzazione</span>
            </div>
            <div class="corso-card__body">
              <div style="margin: 8px 0;">${stateBadges({ N1: '↓', N2: '!', N3: '↓', N4: '↓', N5: '!', N6: '↓', N7: '?' })}</div>
              <p style="font-size: 0.85rem; color: var(--corso-text-muted); font-family: 'JetBrains Mono', monospace;"><strong>R</strong>: relazioni interrotte/caotiche · <strong>D</strong>: ↘ collasso · <strong>T</strong>: T3 · <strong>A</strong>: A−</p>
              ...
              <p class="corso-card__hint">Soglia NPI/clinica; richiede valutazione specialistica.</p>
            </div>
          </div>
        </div>
        ...
        <h3 class="corso-narrative__h3">Legenda dei codici di stato</h3>
        <div class="corso-chips">
          <div class="corso-chip" style="border-left: 4px solid #27ae60;"><span class="corso-chip__label">↑ Espansivo</span></div>
          <div class="corso-chip" style="border-left: 4px solid #2980b9;"><span class="corso-chip__label">~ Stabile</span></div>
          <div class="corso-chip" style="border-left: 4px solid #e67e22;"><span class="corso-chip__label">↓ Ristretto</span></div>
          <div class="corso-chip" style="border-left: 4px solid #e74c3c;"><span class="corso-chip__label">! Disorganizzato</span></div>
          <div class="corso-chip" style="border-left: 4px solid #95a5a6;"><span class="corso-chip__label">? Non leggibile</span></div>
        </div>
      `,
    },
    ...
    // ─── 5.6 ──────────────────────────────────────────────────────────
    {
      ...
      content: `
        <blockquote class="corso-blockquote">«Nessun Nodo, da solo, identifica il rischio: lo fa la configurazione.»</blockquote>
        <p class="corso-narrative__caption">Questo è il motivo per cui il metodo non diagnostica — individua traiettorie.</p>

        <hr class="corso-divider" />

        <h3 class="corso-narrative__h3">Stesso Nodo (N3), tre configurazioni, tre traiettorie</h3>

        <div class="corso-cards corso-cards--vertical">
          <div class="corso-card corso-card--open" style="--corso-card-accent: #27ae60;">
            <div class="corso-card__head"><span class="corso-card__badge">A</span><span class="corso-card__title">N3↑ in campo integrato</span></div>
            <div class="corso-card__body">
          ...
          <div class="corso-card corso-card--open" style="--corso-card-accent: #f39c12;">
            <div class="corso-card__head"><span class="corso-card__badge" style="background: #f39c12;">B</span><span class="corso-card__title">N3~ presente ma discontinuo</span></div>
            <div class="corso-card__body">
              <div style="margin: 4px 0;">${stateBadges({ N1: '~', N2: '~', N3: '~', N4: '~', N7: '~' })}</div>
          ...
          <div class="corso-card corso-card--open" style="--corso-card-accent: #e74c3c;">
            <div class="corso-card__head"><span class="corso-card__badge" style="background: #e74c3c;">D</span><span class="corso-card__title">N3↓ in campo disorganizzato</span></div>
            <div class="corso-card__body">
              <div style="margin: 4px 0;">${stateBadges({ N1: '↓', N2: '!', N3: '↓', N4: '↓', N7: '?' })}</div>
        ...
        <p class="corso-emph corso-emph--center">Stesso Nodo. Tre configurazioni. Tre traiettorie completamente diverse.</p>

        <hr class="corso-divider" />

        <div class="corso-two-col">
          <div class="corso-box corso-box--valid">
            <div class="corso-box__title">✓ Cosa la configurazione permette</div>
            <ul>
          ...
          <div class="corso-box corso-box--invalid">
            <div class="corso-box__title">✗ Cosa evita</div>
            <ul>
    ...
    // ─── 5.7 ──────────────────────────────────────────────────────────
    {
      ...
      content: `
        ...
        <h3 class="corso-narrative__h3">La configurazione</h3>
        ...
        <h3 class="corso-narrative__h3">Le relazioni attive</h3>
        <div class="corso-cards corso-cards--vertical">
          <div class="corso-card corso-card--open" style="--corso-card-accent: #2980b9;">
            <div class="corso-card__head"><span class="corso-card__badge">N2 → N3</span><span class="corso-card__title">MED · Mediazione</span></div>
            <div class="corso-card__body"><p>La co-regolazione del genitore (attende, risponde, sostiene) media l'accesso al mondo condiviso. Quando il genitore anticipa o cambia ritmo, N3 si interrompe.</p></div>
          </div>
          <div class="corso-card corso-card--open" style="--corso-card-accent: #27ae60;">
            <div class="corso-card__head"><span class="corso-card__badge" style="background: #27ae60;">N7 → N3</span><span class="corso-card__title">CPL · Sostegno</span></div>
            <div class="corso-card__body"><p>L'interesse del bambino per alcune figure sostiene i momenti di accesso condiviso. Le sequenze più ricche avvengono sulle figure che lo attraggono.</p></div>
          </div>
          <div class="corso-card corso-card--open" style="--corso-card-accent: #e67e22;">
            <div class="corso-card__head"><span class="corso-card__badge" style="background: #e67e22;">N2 compensa N1</span><span class="corso-card__title">CMP · Compensazione</span></div>
            <div class="corso-card__body"><p>La regolazione non è ancora autonoma — il bambino si regola attraverso il campo adulto. La co-presenza del genitore è condizione dell'esperienza.</p></div>
          </div>
        </div>

        <hr class="corso-divider" />

        <div class="corso-box corso-box--valid" style="border-color: #f39c12; background: #fef5ec;">
          <div class="corso-box__title" style="color: #f39c12;">Configurazione B — Accesso situazionale</div>
        ...
        <h3 class="corso-narrative__h3">CE dal caso-guida</h3>
        <pre style="background: var(--corso-bg); border: 1px solid var(--corso-border); border-radius: var(--corso-radius-md); padding: 16px; font-family: 'JetBrains Mono', 'Fira Code', monospace; font-size: 0.85rem; line-height: 1.55; overflow-x: auto;">
CE =
  ...
  A: A±
        ...
        <p class="corso-narrative__caption"><em>Traduzione naturale</em>: Campo relazionale forte che media l'accesso al mondo condiviso; il desiderio del bambino orienta le sequenze più ricche; la regolazione è sostenuta dall'adulto più che autonoma; la configurazione è fragile ma evolutivamente aperta.</p>

        <p class="corso-emph corso-emph--center" style="margin-top: 16px;">→ Modulo 6 — La Grammatica delle Configurazioni</p>
      `,
      notes:
