...
const TRIADE_CARDS: ExpandableCardData[] = [
    ...
    detail: `
      ...
      <div class="corso-two-col">
        <div class="corso-box corso-box--valid">
          <div class="corso-box__title">✓ Segnali di campo presente</div>
          <ul>
        ...
        <div class="corso-box corso-box--invalid">
          <div class="corso-box__title">✗ Segnali di campo assente</div>
          <ul>
      ...
      <div class="corso-scena" style="border-left-color: #16a085; background: #e8f8f5; margin-top: 12px;">
  ...
  },
  {
    ...
    detail: `
      ...
      <div class="corso-two-col">
        <div class="corso-box corso-box--valid" style="border-color: #8e44ad; background: #f3edf7;">
          <div class="corso-box__title" style="color: #8e44ad;">✓ Segnali di posizione presente</div>
          <ul>
        ...
        <div class="corso-box corso-box--invalid">
          <div class="corso-box__title">✗ Segnali di posizione assente</div>
          <ul>
      ...
      <div class="corso-scena" style="border-left-color: #8e44ad; background: #f3edf7; margin-top: 12px;">
        <p style="font-size: 0.78rem; text-transform: uppercase; letter-spacing: 0.05em; color: var(--corso-text-muted); margin: 0 0 4px;">Nel caso-guida</p>
    ...
    detail: `
      ...
      <div class="corso-two-col">
        <div class="corso-box corso-box--valid" style="border-color: #d35400; background: #fef0e7;">
          <div class="corso-box__title" style="color: #d35400;">✓ Limite integrabile</div>
          <ul>
        ...
        <div class="corso-box corso-box--invalid">
          <div class="corso-box__title">✗ Limite destabilizzante</div>
          <ul>
      ...
      <div class="corso-scena" style="border-left-color: #d35400; background: #fef0e7; margin-top: 12px;">
        <p style="font-size: 0.78rem; text-transform: uppercase; letter-spacing: 0.05em; color: var(--corso-text-muted); margin: 0 0 4px;">Nel caso-guida</p>
...
const PROPRIETA_CARDS: ExpandableCardData[] = [
  {
    ...
    color: '#16a085',
    title: 'Non riduttivo',
    summary: "Mantiene la complessità strutturale dell'esperienza, senza farla coincidere con una sola variabile.",
    detail: `
      <p>«Non riduttivo» è qui un attributo tecnico dell'operatore, non un giudizio sulle discipline: significa che lo strumento, per come è costruito, non fa coincidere il fenomeno osservato con una sola variabile (biologica, comportamentale, cognitiva). Mantiene aperta la complessità strutturale dell'esperienza, in modo che più sguardi disciplinari possano trovarvi un terreno comune.</p>
      <div class="corso-section" style="background: var(--corso-bg); padding: 12px 16px; border-radius: var(--corso-radius-sm);">
        <p style="text-decoration: line-through; color: var(--corso-text-muted); margin: 0 0 6px;"><strong>✗</strong> «Il bambino non presta attenzione»</p>
  ...
  },
  {
    ...
    detail: `
      ...
      <div class="corso-section" style="background: var(--corso-bg); padding: 12px 16px; border-radius: var(--corso-radius-sm);">
        <p style="text-decoration: line-through; color: var(--corso-text-muted); margin: 0 0 6px;"><strong>✗</strong> «Il genitore non è abbastanza responsivo»</p>
  ...
  },
  {
    ...
    detail: `
      ...
      <div class="corso-section" style="background: var(--corso-bg); padding: 12px 16px; border-radius: var(--corso-radius-sm);">
        <p style="text-decoration: line-through; color: var(--corso-text-muted); margin: 0 0 6px;"><strong>✗</strong> «Assenza di attenzione condivisa — segnale di rischio DSA»</p>
  ...
  },
  {
    ...
    detail: `
      ...
      <div class="corso-section" style="background: var(--corso-bg); padding: 12px 16px; border-radius: var(--corso-radius-sm);">
        <p style="text-decoration: line-through; color: var(--corso-text-muted); margin: 0 0 6px;"><strong>✗</strong> «Il bambino non interagisce»</p>
  ...
  },
  {
    ...
    detail: `
      ...
      <div class="corso-section" style="background: var(--corso-bg); padding: 12px 16px; border-radius: var(--corso-radius-sm); border-left: 3px solid #8e44ad;">
...
export const Module07: Module = {
  ...
  slides: [
    // ─── 7.1 ──────────────────────────────────────────────────────────
    {
      ...
      content: `
        <p class="corso-narrative__caption">Un operatore di lettura produce <strong>leggibilità</strong>. Non produce azione. L'azione è compito di F3.</p>
      `,
    },
    ...
    // ─── 7.2 ──────────────────────────────────────────────────────────
    {
      ...
      intro: `
        <p class="corso-emph corso-emph--center" style="color: var(--corso-text-muted);">Ogni situazione = Campo + Posizione + Limite</p>
      `,
      interactive: {
        ...
        <div class="corso-two-col corso-two-col--40-60">
          <div class="corso-col">
            <div class="corso-cards corso-cards--vertical">
              <div class="corso-card corso-card--open" style="--corso-card-accent: var(--corso-text-muted); opacity: 0.7;">
                <div class="corso-card__head">
                  <span class="corso-card__badge" style="background: var(--corso-text-muted);">4</span>
                  <span class="corso-card__title">Domande professionali</span>
                </div>
                <div class="corso-card__body" style="font-size: 0.85rem;"><p><em>«Il bambino usa l'oggetto come occasione di scambio con l'adulto?»</em></p></div>
              </div>

              <p class="corso-emph corso-emph--center" style="color: var(--corso-text-muted); margin: 0;">↓ applica l'operatore triadico</p>

              <div class="corso-card corso-card--open" style="--corso-card-accent: #d35400; box-shadow: 0 0 0 2px #d35400; background: #fef0e7;">
                <div class="corso-card__head">
                  <span class="corso-card__badge">◆ 5</span>
                  <span class="corso-card__title">Operatore triadico — qui</span>
                </div>
                <div class="corso-card__body" style="font-size: 0.85rem;">
                  <p><strong>Campo condiviso · Posizione · Limite</strong></p>
                  <p>→ Lettura sintetica del campo</p>
                </div>
              </div>

              <p class="corso-emph corso-emph--center" style="color: var(--corso-text-muted); margin: 0;">↓ produce</p>

              <div class="corso-card corso-card--open" style="--corso-card-accent: #16a085;">
                <div class="corso-card__head">
                  <span class="corso-card__badge" style="background: #16a085;">CE</span>
                  <span class="corso-card__title">Configurazione Evolutiva (M6)</span>
                </div>
                <div class="corso-card__body" style="font-size: 0.82rem; font-family: 'JetBrains Mono', monospace;"><p>S: N1~ N2↑ N3~ N4↓… · D: ↗ · A: A±</p></div>
              </div>

              <p class="corso-emph corso-emph--center" style="color: var(--corso-text-muted); margin: 0;">↓ apre a</p>

              <div class="corso-card corso-card--open" style="--corso-card-accent: var(--corso-text-muted); opacity: 0.7;">
                <div class="corso-card__head">
                  <span class="corso-card__badge" style="background: var(--corso-text-muted);">6</span>
                  <span class="corso-card__title">Famiglie di output (M8)</span>
                </div>
                <div class="corso-card__body" style="font-size: 0.85rem;"><p>Osservativa · Formativa · Restitutiva…</p></div>
              </div>
            </div>
          </div>
          ...
          <div class="corso-col">
            ...
            <p class="corso-emph corso-emph--center" style="margin-top: 16px;">→ Modulo 8 — Famiglie di output e Output-tipo</p>
          </div>
        </div>
      `,
    },
