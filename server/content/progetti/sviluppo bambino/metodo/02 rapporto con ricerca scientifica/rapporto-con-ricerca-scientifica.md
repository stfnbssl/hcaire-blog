---
id: rapporto-con-ricerca-scientifica
titolo: "Rapporto con la ricerca scientifica"
fonti:
  - om5-collocazione-ecosistema-ricerca-scientifica
  - om5b-statuto-epistemologico-ecosistema-ricerca-scientifica
data: 2026-04-21
stato: bozza
---
...
**Livello 2 — Progettazione di strumenti contestualizzati**
Traduce la fondazione concettuale in dispositivi operativi utilizzabili nei contesti professionali — osservativi, formativi, di lettura delle situazioni relazionali. Nel progetto questo livello è rappresentato da F3 e dai suoi output-tipo vuoti. Gli strumenti sono strutture aperte, progettate per sostenere il giudizio professionale senza sostituirlo.

**Livello 3 — Ricerca empirica**
Produce evidenza attraverso studi osservazionali, longitudinali, comparativi, valutazioni di efficacia. Questo è il dominio proprio della ricerca evidence-based. Il progetto non si sostituisce a questo livello, ma può contribuire a orientarlo fornendo categorie analitiche più coerenti con la natura multilivello dei fenomeni di sviluppo.

Il Progetto Sviluppo Bambino opera ai livelli 1 e 2. La relazione con il livello 3 è di preparazione e orientamento, non di sostituzione.
...
**Traducibilità**: i costrutti sono traducibili in modo controllato tra discipline diverse senza perdere significato o produrre distorsioni?
